...
{
    public async Task Execute(PersistenceCommandInfo commandInfo, Guid eventId)
    {
    ...
    private async Task ExecuteCommand(PersistenceCommandInfo commandInfo, MySqlConnection connection, MySqlTransaction transaction)
    {
